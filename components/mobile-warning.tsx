...
// Define the props for the MobileWarning component
interface MobileWarningProps {
  onContinue: () => void
}

/**
 * Renders a warning message for users on mobile devices.
 * Recommends viewing the site on a desktop for the best experience.
 * @param {MobileWarningProps} props - The props for the component.
 * @returns {JSX.Element} The MobileWarning component.
 */
    ...
    <div className="fixed inset-0 bg-[#f5f2e8] z-[100] flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="space-y-3">
          ...
          {/* Button to dismiss the warning and continue */}
          <button
            onClick={onContinue}
        ...
        {/* Quick info section for mobile users */}
