...
const PLACEHOLDER_PROJECTS = [
  { id: 1, name: "Fakebook", description: "Simulates an OTP grabbing attack using social engineering techniques", techStack: ["Next.js", "Typescript", "Tailwind CSS"], liveDemo: "https://example.com" },
